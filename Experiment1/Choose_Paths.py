...
#a script to generate random amount of segments from (user passed) amount of ground truth paths.
...
#Argument 4: Directory which containes city paths information
