...
directory_april_2013=/scratch/user/architsh/PathSegmentsApril2013
directory_october_2012=/scratch/user/architsh/PathSegmentsOctober2012

#echo 'Breaking April 2013 File into Path Segments'
#python ./Break_Into_Path_Segment_Multiprocessing.py $file_april_2013 $time_diff $max_dist april 2013
#echo 'Done Breaking April 2013 File'
echo 'Breaking October 2013 File into Path Segments'
python ./Break_Into_Path_Segment_Multiprocessing.py $file_october_2012 $time_diff $max_dist october 2012
